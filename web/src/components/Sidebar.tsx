...
const Menus = () => {
    return (
        <nav className="flex w-full flex-col items-center justify-center gap-14">
...
export const Sidebar = () => {
    return (
        <aside className="flex flex-col h-screen w-28 bg-white items-center justify-between py-14">
